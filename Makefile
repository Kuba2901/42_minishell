...
MINI_BUILTINS_SRC = $(BUILTINS_DIR)/builtin_pwd.c $(BUILTINS_DIR)/builtin_env.c $(BUILTINS_DIR)/builtin_unset.c $(BUILTINS_DIR)/builtin_set_private.c $(BUILTINS_DIR)/builtin_export.c $(BUILTINS_DIR)/builtin_export_ext.c $(BUILTINS_DIR)/builtin_exit.c $(BUILTINS_DIR)/builtin_echo.c $(BUILTINS_DIR)/builtin_cd.c
